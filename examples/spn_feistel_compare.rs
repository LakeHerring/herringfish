...
fn main() {
    let samples = 100000;
    println!("SPN vs Feistel comparative differential sampling, samples={}", samples);
    println!("SPN placeholder max prob ≈ {:.6}", spn_diff_max_rounds(14, samples));

...
fn main() {
    ...
    for rounds in [4usize,6usize] {
        ...
        println!("Rounds {}: heuristic best characteristic prob ≈ {:.3e} for 1-bit Δin = {:#x}", rounds, best, best_in);
    }
    println!("Note: this is a simplified DDT-based bound. Full exact search requires joint distribution across the linear diffusion layer.");
}
